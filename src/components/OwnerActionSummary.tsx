...
const toneStyles: Record<Tone, string> = {
  ...
  zinc: "text-zinc-400 bg-[#181A1C] border-[#24272C]",
};
...
function StatusCard({
  ...
  return (
    <div className="rounded-2xl border border-[#24272C] bg-[#141618] p-5 hover:border-white transition-all duration-200 group">
      <div className="flex items-center justify-between gap-3 mb-2">
        <p className="text-[9px] font-mono uppercase tracking-widest text-zinc-500 group-hover:text-zinc-400 transition-colors">
          {title}
        </p>
      ...
      <p className="mt-2 text-xs text-zinc-500 leading-relaxed">{desc}</p>
    </div>
  );
}
...
export default function OwnerActionSummary({
        ...
        <div className="animate-pulse space-y-6">
          <div className="flex flex-col xl:flex-row gap-6">
            <div className="flex-1 space-y-4">
              <div className="h-4 w-52 rounded bg-[#24272C]" />
              <div className="h-10 w-full max-w-xl rounded bg-[#24272C]" />
              <div className="h-5 w-full max-w-2xl rounded bg-[#24272C]" />
              <div className="flex gap-2">
                <div className="h-7 w-32 rounded-full bg-[#24272C]" />
                <div className="h-7 w-32 rounded-full bg-[#24272C]" />
              </div>
            </div>
            <div className="h-52 w-full xl:w-[360px] rounded-2xl bg-[#141618] border border-[#24272C]" />
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
            <div className="h-32 rounded-2xl bg-[#141618] border border-[#24272C]" />
            <div className="h-32 rounded-2xl bg-[#141618] border border-[#24272C]" />
            <div className="h-32 rounded-2xl bg-[#141618] border border-[#24272C]" />
            <div className="h-32 rounded-2xl bg-[#141618] border border-[#24272C]" />
          </div>
  ...
  return (
    <section className="mb-8 rounded-2xl border border-[#24272C] bg-[#181A1C] p-5 md:p-6 shadow-lg overflow-hidden relative">
      ...
      <div className="relative flex flex-col xl:flex-row gap-6">
        <div className="flex-1">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <div className="flex flex-wrap items-center gap-2 text-[9px] font-mono uppercase tracking-widest text-zinc-500">
              <span className="rounded-md border border-[#24272C] bg-[#141618] px-2.5 py-1">
                {periodLabel}
              </span>
              <span className="hidden sm:inline-flex items-center gap-1 rounded-md border border-[#24272C] bg-[#141618] px-2.5 py-1">
          ...
          <div className="mt-6 flex items-start gap-4">
            ...
            <div>
              <h2 className="flex items-center gap-3 text-2xl font-bold tracking-tight text-white leading-tight">
                <span className="sm:hidden">{headlineIcon}</span>
                {headline}
              </h2>

              <p className="mt-2 max-w-2xl text-xs md:text-sm leading-relaxed text-zinc-400">
                {headlineDesc}
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-3">
            ...
            <button
              type="button"
              className="inline-flex items-center justify-center gap-2 rounded-xl border border-[#24272C] bg-[#141618] px-5 py-2.5 text-xs font-semibold text-white hover:border-white transition"
            >
              View Details
        ...
        <div className="w-full xl:w-[360px] rounded-2xl border border-[#24272C] bg-[#141618] p-5 self-stretch flex flex-col">
          ...
          <h3 className="mt-4 text-xl font-bold tracking-tight text-white leading-tight">
            {mainActionTitle}
          </h3>
            ...
            <button
              ...
              className={`w-full rounded-xl border px-4 py-2.5 text-xs font-bold transition flex items-center justify-center gap-2 ${
                mainActionTone === "emerald" 
                  ...
                  : `${toneStyles[mainActionTone]} hover:bg-black/20`
              }`}
            >
              {mainActionLabel}
              <ArrowRight className="h-3.5 w-3.5" />
